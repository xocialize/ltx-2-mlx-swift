...
// (BRIDGE M4: the PACKAGE auto-materializes; the app only picks the models folder).
//
// Executes the `WeightSourcing` declaration on LTX2Configuration: each missing source's repo is
// snapshot-downloaded into the engine ModelStore layout (`<root>/<org>/<name>/…`) via
