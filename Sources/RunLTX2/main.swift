...
if args.contains("--connector-gate") {
    ...
    try await benchE2E()
} else if args.contains("--vae-rf-probe") || args.contains("--vae-tile-gate") || args.contains("--vae-tile-bench") || args.contains("--vae-mux-bench") || args.contains("--vae-encode-tile-gate") || args.contains("--vae-encode-tile-probe") {
